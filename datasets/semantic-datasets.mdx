...
Select any attributes from the [40 available attributes](/home/daytona/workspace/source/laft/datasets/celeba.py:12-53):
...
<Card title="Source Code" icon="code" href="https://github.com/yourusername/laft/blob/main/laft/datasets/__init__.py">
